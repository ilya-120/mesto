...
export const popupEditAvatarSelector = '#popup-avatar';
...
export const photoTitleSelector = '.elements__card-title';
export const profileImgSelector = '.profile__avatar';
export const likesVolumeSelector = '.element__likes-volume';
export const userId = {};
